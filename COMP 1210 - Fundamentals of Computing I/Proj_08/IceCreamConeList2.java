...
* @return the ice cream cone with shortest radius.
*/   
   public IceCreamCone findIceCreamConeWithShortestRadius()
   {
      ...
      double shortest = iceList[0].getRadius();
      int indexNumber = 0;
      int i = 1;
      while (i < numOfIce)
      {
         if (iceList[i].getRadius() < shortest)
         {
            shortest = iceList[i].getRadius();
            indexNumber = i;
         }
         i++;
      }
      return iceList[indexNumber];
   }
/**
* Finds the ice cream cone with the longest radius.
* @return the ice cream cone with longest radius.
*/     
   public IceCreamCone findIceCreamConeWithLongestRadius()
   {
      ...
      double longest = iceList[0].getRadius();
      int indexNumber = 0;
      int i = 1;
      while (i < numOfIce)
      {
         if (iceList[i].getRadius() > longest)
         {
            longest = iceList[i].getRadius();
            indexNumber = 1;
         }
         i++;
      }
...
* @return the ice cream cone with smallest volume.
*/    
   public IceCreamCone findIceCreamConeWithSmallestVolume()
   {
      ...
      double smallest = iceList[0].volume();
      int indexNumber = 0;
      int i = 1;
      while (i < numOfIce)
      {
         if (iceList[i].volume() < smallest)
         {
            smallest = iceList[i].volume();
            indexNumber = i;
         }
         i++;
      }
...
* @return the ice cream cone with the largest volume
*/   
   public IceCreamCone findIceCreamConeWithLargestVolume()
   {
      ...
      double largest = iceList[0].volume();
      int indexNumber = 0;
      int i = 1;
      while (i < numOfIce)
      {
         if (iceList[i].volume() > largest)
         {
            largest = iceList[i].volume();
            indexNumber = i;
         }
         i++;
      }
